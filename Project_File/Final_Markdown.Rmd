...
This function takes in a Spotify Playlist Object and returns a data frame with track name, artist name, popularity
score and lyrics. The 2 packages used were the spotifyr and genius package.
...
playlist_to_df <- function(playlist){
  ...
  #output DF is dataframe with name, artist, pop score, and lyrics
  return(outputDF)
}
